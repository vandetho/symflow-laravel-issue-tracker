<div class="space-y-6">
    ...
    {{-- Workflow diagram: locally-rendered Mermaid with active places highlighted per issue --}}
    <div class="rounded-2xl border border-zinc-200 bg-white shadow-xs">
        <div class="flex items-center justify-between border-b border-zinc-100 px-6 py-4">
            <div>
                ...
                <p class="mt-0.5 text-xs text-zinc-500">Mermaid render with active places highlighted per issue.</p>
            </div>
        </div>
        <div class="p-4">
    ...
    <div class="rounded-2xl border border-zinc-200 bg-white shadow-xs">
        ...
        <div class="p-2">
            ...
            <iframe wire:key="symflowbuilder-iframe-{{ $embedMarking }}"
                    src="https://symflowbuilder.com/embed/9e50940e6f0e0d02?branding=0&minimap=0&scenario=0{{ $embedMarking !== '' ? '&marking='.$embedMarking : '' }}"
